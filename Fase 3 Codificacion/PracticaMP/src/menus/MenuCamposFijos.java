...
public class MenuCamposFijos {
    ...
    public MenuCamposFijos(Personaje p) {
        ...
        mensaje = "El valor introducido no es un valor valido para el campo que quiere modificar. Procure introducir el numero de alguno de los elementos.";
    ...
    public String mostrarMensaje(String campo, String valores) {
        ...
        System.out.println("Introduce la posicion del valor que guardar, 'guardar' para guardar los cambios, o 'salir' para cancelar.");
